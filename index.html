...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="Omnifood is a preium food delivery service with the mission to bring affordable and healthy meals to as many people as possible.">
...
We don't limit your creativity, which means you can order whatever you feel like. You can also choose from our menu containing over 100 delicious meals. It's up to you!</p>
        ...
        <section class="section-steps" id="works">
            ...
            <div class="row">
                    ...
                    <div class="col span-1-of-2 steps-boxx">
                        ...
                        <a href="#" class="btn-app"><img src="resources/css/img/download-app.svg" alt="Apple store button"></a>
                        <a href="#" class="btn-app"><img src="resources/css/img/download-app-android.png" alt="Android store button"></a>
                    </div>
                </div>
        </section>
        <section class="section-cities" id="cities">
            ...
            <div class="row js--wp-3">
                <div class="col span-1-of-4 box">
                    <img src="omnifood-contents/lisbon-3.jpg" alt="Lisbon">
                    <h3>Lisbon</h3>
                    <div class="city-feature">
                        <i class="ion-person icon-small"></i>1600+ happy eaters
                    </div>
                    <div class="city-feature">
                ...
                <div class="col span-1-of-4 box">
                    <img src="omnifood-contents/san-francisco.jpg" alt="San Francisco">
                    <h3>San Francisco</h3>
                    <div class="city-feature">
                        <i class="ion-person icon-small"></i>3700+ happy eaters
                    </div>
                    <div class="city-feature">
                ...
                <div class="col span-1-of-4 box">
                    <img src="omnifood-contents/berlin.jpg" alt="Berlin">
                    <h3>Berlin</h3>
                    <div class="city-feature">
                        <i class="ion-person icon-small"></i>2300+ happy eaters
                    </div>
                    <div class="city-feature">
                ...
                <div class="col span-1-of-4 box">
                    <img src="omnifood-contents/london.jpg" alt="London">
                    <h3>London</h3>
                    <div class="city-feature">
                        <i class="ion-person icon-small"></i>1200+ happy eaters
                    </div>
                    <div class="city-feature">
            ...
            <div class="row">
                <div class="col span-1-of-3">
                   <blockquote>Omnifood is just awesome! I just launched a startup which leaves me with no time for cooking, so Omnifood is a life-saver. Now that I got used to it, I couldn't live without my daily meals!
                    <cite><img src="omnifood-contents/customer-1.jpg" alt="Alberto Duncan image">&mdash;Alberto Duncan</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    ...
                    <cite><img src="omnifood-contents/customer-2.jpg" alt="Joana Silva image">&mdash;Joana Silva</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    ...
                    <cite><img src="omnifood-contents/customer-3.jpg" alt="Milton Chapman picture">&mdash;Milton Chapman</cite>
                    </blockquote>
                </div>
            </div>
        </section>
                    ...
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                ...
                                <li><i class="ion-ios-checkmark-empty icon-small"></i>Free deilvery</li>
                            </ul>
                        </div>
                        <div>
                            <a href ="#" class="btn btn-ghost">Sign up now</a>
